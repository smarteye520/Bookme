 ...
 * about a string or a prompt, including top_left_menu data for a verification prompt.
 */
...
/*
 * Return the string to top_left_menu the result against.  Only useful with verifies.
 */
